...
class Product:
    ...
    def __init__(self, symbol: str, limit: int, learning_rate=1e-3):
    ...
    def linear_regression(self, window_size: int = None) -> tuple[float, float]:
        ...
        Iterations are 1-indexed. (Because stuff didn't converge for 0-indexed.)
...
class Trader:
    ...
    def trade_squid_ink(self) -> None:
        ...
        x = len(squid_ink.mid_price_history)
        fair_value = m * x + b
    ...
    def trade_croissants(self) -> None:
        ...
        x = len(croissant.mid_price_history)
        fair_value = m * x + b
